      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Suspense fallback={<PageLoader />}>
            ...
            {/* ========== RESOURCES: PROFESSIONAL OUTCOMES (GATED) ========== */}
            ...
            <Route path="/professional/clinical-outcomes-review/:episodeId" element={<ClinicalOutcomesReview />} />
            ...
            >
              ...
              <Route path="valuation-narrative" element={<ValuationNarrativePage />} />
              <Route path="external-snapshot" element={<ExternalSnapshotPage />} />
            </Route>
