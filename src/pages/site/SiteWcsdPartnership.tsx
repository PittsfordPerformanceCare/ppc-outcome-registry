        ...
        <section className="py-16 lg:py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-lg dark:prose-invert">
                <p className="text-muted-foreground leading-relaxed">
                  When a partnership between clinic and classroom works, the benefits extend 
                  beyond individual students. Families gain earlier insight into their child's 
                  development. Educators gain context that may inform their approach. And the 
                  broader community benefits from a school system committed to thoughtful, 
